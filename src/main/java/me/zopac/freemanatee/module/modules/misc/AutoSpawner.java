...
import static me.zopac.freemanatee.util.BlockInteractionHelper.*;

@Module.Info(name = "AutoSpawner", category = Module.Category.MISC)
public class AutoSpawner extends Module {

    private static boolean isSneaking;

    private Setting<UseMode> useMode = register(Settings.e("UseMode", UseMode.SINGLE));
