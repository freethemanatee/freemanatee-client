...
public class KamiTessellator2 extends Tessellator {

    public static KamiTessellator2 INSTANCE = new KamiTessellator2();

    public KamiTessellator2() {
        super(0x200000);
    }
    ...
    public static void drawFullBox(AxisAlignedBB bb, BlockPos blockPos, float width, int red, int green, int blue, int alpha) {
        KamiTessellator2.drawBox(blockPos, red, green, blue, alpha, 63);
        KamiTessellator2.release();
        KamiTessellator2.prepare(7);
        KamiTessellator2.drawBoundingBox(bb, width, red, green, blue, 255);
    }
    ...
    public static void drawBoundingBox(AxisAlignedBB bb, float width, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        KamiTessellator2.drawBoundingBox(bb, width, r, g, b, a);
    }
