...
public class GUI extends Module {
    ...
    private Setting<Integer> guiRed = register(Settings.integerBuilder("GuiRed").withMinimum(1).withValue(143).withMaximum(255).build());
    private Setting<Integer> guiGreen = register(Settings.integerBuilder("GuiGreen").withMinimum(1).withValue(182).withMaximum(255).build());
    private Setting<Integer> guiBlue = register(Settings.integerBuilder("GuiBlue").withMinimum(1).withValue(65).withMaximum(255).build());
    ...
    private Setting<Integer> moduleListRed = register(Settings.integerBuilder("ModuleListRed").withMinimum(1).withValue(255).withMaximum(255).withVisibility(v -> moduleListMode.getValue().equals(GuiManager.ModuleListMode.STATIC)).build());
    ...
    private Setting<Integer> moduleListBlue = register(Settings.integerBuilder("ModuleListBlue").withMinimum(1).withValue(255).withMaximum(255).withVisibility(v -> moduleListMode.getValue().equals(GuiManager.ModuleListMode.STATIC)).build());
