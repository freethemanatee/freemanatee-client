 ...
 * Updated by zopac on 07/31/20
 */

@Module.Info(name = "ElytraFlight", category = Module.Category.MOVEMENT)
...
//        sendChatMessage("Rotation: " + mc.player.rotationPitch + " Camera: " + mc.player.cameraPitch);
    ...
    private void takeOff() {
        ...
        if (mc.player.isElytraFlying()) {
            ...
            Command.sendChatMessage(" Disabled Takeoff ");
        }
    }
    ...
    private void defaults() {
        ...
        Command.sendChatMessage(" Set to defaults! ");
        Command.sendChatMessage(" Close and open the elytrafly settings! ");
    }
