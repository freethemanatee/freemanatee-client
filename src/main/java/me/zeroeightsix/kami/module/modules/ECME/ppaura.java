...
public class ppaura extends Module {
    ...
    private Setting<Integer> waitTick = register(Settings.integerBuilder("Tick Delay").withMinimum(0).withValue(-2000).withVisibility(o -> waitMode.getValue().equals(WaitMode.STATIC)).build());
