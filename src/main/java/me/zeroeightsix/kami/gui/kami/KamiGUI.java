...
public class KamiGUI extends GUI {
    ...
    public void initializeGUI() {
        ...
        information.addTickListener(() -> {
            information.setText("");
            information.addLine(KamiMod.getInstance().guiManager.getTextColor() + Math.round(LagCompensator.INSTANCE.getTickRate()) + ChatFormatting.DARK_GRAY.toString() + " tps  |  " + KamiMod.getInstance().guiManager.getTextColor() + Wrapper.getMinecraft().debugFPS + ChatFormatting.DARK_GRAY.toString() + " fps");
        });
        ...
        greeter.addTickListener(() -> {
            ...
            greeter.setText("");
            greeter.addLine(ChatFormatting.DARK_AQUA.toString() + "Welcome " + KamiMod.getInstance().guiManager.getTextColor() + Wrapper.getMinecraft().player.getDisplayNameString() + ChatFormatting.DARK_AQUA.toString() + " :)");
        });
        ...
        watermark.addTickListener(() -> {
            ...
            watermark.setText("");
            watermark.addLine(KamiMod.getInstance().guiManager.getTextColor() + KamiMod.NAME_UNICODE);
        });
