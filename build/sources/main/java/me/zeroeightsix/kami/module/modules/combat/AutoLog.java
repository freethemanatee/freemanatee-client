...
public class AutoLog extends Module
{
    ...
    public AutoLog() {
        ...
        this.entityJoinWorldEventListener = new Listener<EntityJoinWorldEvent>(event -> {
            if (AutoLog.mc.player != null) {
                if (event.getEntity() instanceof EntityEnderCrystal && AutoLog.mc.player.getHealth() - AutoCrystal2.calculateDamage((EntityEnderCrystal)event.getEntity(), (Entity)AutoLog.mc.player) < this.health.getValue()) {
                    this.log();
                }
            }
