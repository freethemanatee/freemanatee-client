...
import static me.zopac.freemanatee.util.EntityUtil.calculateLookAt;
...
public class WebHoleFiller extends Module {
    ...
    private boolean IsHole(BlockPos blockPos) {
        ...
        if ((mc.world.getBlockState(boost).getBlock() == Blocks.AIR
                ...
                && ((mc.world.getBlockState(boost3).getBlock() == Blocks.WEB) || (mc.world.getBlockState(boost3).getBlock() == Blocks.BEDROCK))
                && ((mc.world.getBlockState(boost4).getBlock() == Blocks.WEB) || (mc.world.getBlockState(boost4).getBlock() == Blocks.BEDROCK))
                && ((mc.world.getBlockState(boost5).getBlock() == Blocks.WEB) || (mc.world.getBlockState(boost5).getBlock() == Blocks.BEDROCK))
                && ((mc.world.getBlockState(boost6).getBlock() == Blocks.WEB) || (mc.world.getBlockState(boost6).getBlock() == Blocks.BEDROCK))
                && (mc.world.getBlockState(boost8).getBlock() == Blocks.AIR)
                && ((mc.world.getBlockState(boost9).getBlock() == Blocks.WEB) || (mc.world.getBlockState(boost9).getBlock() == Blocks.BEDROCK)))) {
            return true;
        } else {
            return false;
        }
