...
import me.zopac.freemanatee.module.modules.render.Tracers;
...
import static me.zopac.freemanatee.util.ColourConverter.rgbToInt;
import static me.zopac.freemanatee.util.ColourConverter.toF;
...
@Module.Info(name = "AutoCrystal2", category = Module.Category.COMBAT, description = "Places End Crystals to kill enemies")
public class AutoCrystal2 extends Module {
    ...
    public void onUpdate() {
        ...
        if (defaultSetting.getValue()) {
            ...
            sendChatMessage("Set to defaults!");
        }
    ...
    public void onEnable() { sendMessage("&a manatee is free&r"); }

    public void onDisable() {
        sendMessage("&c manatee is no longer free&r");
        render = null;
        renderEnt = null;
        resetRotation();
    }
